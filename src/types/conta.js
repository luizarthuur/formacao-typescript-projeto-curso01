...
var Tipo_transacao_js_1 = require("./Tipo-transacao.js");
...
var Conta = {
    ...
    registrarTransacao: function (novaTransacao) {
        if (novaTransacao.tipoTransacao == Tipo_transacao_js_1.TipoTransacao.DEPOSITO) {
            depositar(novaTransacao.valor);
        }
        else if (novaTransacao.tipoTransacao == Tipo_transacao_js_1.TipoTransacao.TRANSFERENCIA || novaTransacao.tipoTransacao == Tipo_transacao_js_1.TipoTransacao.PAGAMENTO_BOLETO) {
